...
const finals2014 = fifaData.filter((teams) => {
...
console.log('2014 World Cup Winner:', finals2014[0]['Win conditions']);
...
function getFinals(array) {
   const finalStageTeams = array.filter((teams) => {
...
function getAverageGoals(getFinalsCB) {          
  ...
  let averageHomeGoals = getFinalsCB.reduce(function(acc, item){
